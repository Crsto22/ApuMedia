...
const Chats = () => {
    const { users, messages, currentChatId, selectChat, sendMessage } = useChat();
    const { user } = useAuth();
    ...
    const currentChatUser = users.find(u => u.uid === currentChatId);
                                ...
                                <div className="bg-white border-b border-gray-100">
                                    <div className="px-6 py-4 flex items-center">
                                        <div className="flex items-center flex-1">
                                            <div className={`w-14 h-14 rounded-2xl ${generateUserColor(currentChatId)} flex items-center justify-center shadow-md`}>
                                            ...
                                            {messages.map((msg) => (
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        <span className={`absolute -bottom-5 text-[10px] opacity-0 group-hover:opacity-100 transition-opacity
                                                            ${msg.senderId === user.uid ? "right-0" : "left-0"}
                                                            ${msg.senderId === user.uid ? "text-gray-500" : "text-gray-500"}`}>
