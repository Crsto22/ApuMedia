...
const ModalEditarCuenta = ({ isOpen, onClose, onSubmit, cuenta }) => {
  ...
  useEffect(() => {
    if (cuenta) {
      setFormData({
        ...
        usuarios_maximos: cuenta.usuarios_maximos || 1,
        precio_total: cuenta.precio_total || "",
        precio_por_perfil: cuenta.precio_por_perfil || "",
        detalles: {
          plan: cuenta.detalles?.plan || "",
          calidad: cuenta.detalles?.calidad || ""
        },
        credenciales: {
          email: cuenta.credenciales?.email || "",
          password: cuenta.credenciales?.password || ""
        },
